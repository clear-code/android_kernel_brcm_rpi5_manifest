...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/clear-code/android_kernel_manifest/android-14.0-docker/manifest_brcm_rpi.xml --create-dirs
```
